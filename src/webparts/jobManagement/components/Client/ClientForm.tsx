...
const ClientForm = (props:any):JSX.Element =>{
    ...
    const handleSubmit = async (btnVal:string) =>{
        ...
        if(submitAuthetication){
            ...
            await sp.web.lists.getByTitle('Client').items.add(newJson)
            .then((result)=>{                                
    ...
    async function createFolder(ItemID)
    {
        ...
        await sp.web.rootFolder.folders.getByName("ClientAttachment").folders.addUsingPath(ItemID.toString(),true)
        .then(async (result)=> 
        {
            ...
            <div className={styles.formContainer}>
                ...
                <div className={styles.formContent}>
                    <div className={styles.inputAlign}>
                        <div>
                            <TextField value={data.Name} label='Client Name' styles={text} name='Client Name' onChange={(event)=>handleInputValue(event)} disabled={false}/>
                        </div>
                        <div>
