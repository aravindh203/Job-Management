            ...
            <div className={styles.formContainer}>
                ...
                <div className={styles.formContent}>
                    <div className={styles.inputAlign}>
                        <div>
                            <TextField value={data.Name} label='Provider Name' styles={text} name='Provider Name' onChange={(event,text)=>handleInputValue("Name",text)} disabled={isViewAuthentication}/>
                        </div>
                        <div>
